...
import com.gigamog.HttpUtil.headers.HApiKey;
import com.gigamog.HttpUtil.headers.HJwt;
...
public class HttpUtil {
	...
	public static Resp HttpGet(String urlToRead, ArrayList<Header> heads, boolean test) {	
		...
		try {
			...
			ex.printStackTrace();
			return new Resp(CustomResponses.serverErrorResponse());
